        ...
        */
        readPrivateKeyFromFile: function readPrivateKeyFromFile(keyFile, passphrase, isOutputString){
            return typeof passphrase === 'string' ?
                this.convertToString(pki.privateKeyToPem(pki.decryptRsaPrivateKey(fs.readFileSync(keyFile), passphrase)), isOutputString) :
                this.normalizePemString(fs.readFileSync(keyFile).toString());
        },
        /**
